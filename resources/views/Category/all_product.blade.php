                ...
                <div  class="product__item" style='cursor: pointer'>
                    <div class="product__item__pic set-bg" style='height: 200px; width: 300px' data-setbg="{{ asset('storage/images/product/' . $category['image']) }}">
                        ...
                        <ul class="product__hover"> 
                            <li>
                               <a href="{{ asset('storage/images/product/' . $category['image']) }}"  onclick="preventDefaultAction(event)" class="image-popup"><span class="arrow_expand"></span></a>
                            </li>
                            {{-- <li><form method='post' action='{{url('add-to-wishlist')}}'>@csrf <a href="#"><span type="submit" class="icon_heart_alt"></span></a><input type="hidden" name="product_id" value="{{$category->id}}"></form></li> --}}
                            @php
