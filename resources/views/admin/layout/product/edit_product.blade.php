                        ...
                        <div class="cm-content-body form excerpt">
                            <div class="card-body">
                                <form enctype="multipart/form-data" id="form" action="update_product" method="POST">
                                    @csrf
                                    <div class="row gx-2">
                                        <div class="col-12 mb-3"><input class="form-control" name="id"
                                                value='{{ $data->id }}' type="hidden"></div>
                                        <div class="col-12 mb-3"><label class="form-label" for="product-name">Product
                                                name:</label><input class="form-control" value='{{ $data->name }}'
                                                name="product_name" type="text"></div>
                                        ...
                                        <div class="col-12 mb-3">
                                            ...
                                            <select class="form-control" name="c_id">
                                                ...
                                                </option> <!-- Display currently selected category -->
                                        ...
                                        <div class="col-12 mb-3"><label class="form-label"
                                                for="manufacturar-name">Description:</label><input class="form-control"
                                        ...
                                        <div class="col-12 mb-3"><label class="form-label" for="product-image">Product
                                                Image:</label><br><img
                                                src="{{ asset('storage/images/product/' . $data['image']) }}"
                                                width="100px" height="70px"><input class="form-control mt-2"
                                                name='product_image[]' id="product-image" type="file" multiple></div>
                                        <div class="col-12 mb-3"><label class="form-label"
                                                for="product-price">Quantity:</label><input class="form-control"
                                                id="quantity" value='{{ $data->qty }}' name='qty'
                                                type="text"></div>
                                        <div class="col-6 mb-3"><label class="form-label"
                                                for="product-price">Price:</label><input class="form-control"
                                                id="price" value='{{ $data->price }}' name='price'
                                                type="text"></div>
                                        <div class="col-6 mb-3"><label class="form-label" for="product-price">Sell
                                                Price:</label><input class="form-control" id="sell-price"
                                                value='{{ $data->sell_price }}' name='sell_price' type="text"></div>
                                        <div class="col-12 mb-3"><button class="btn btn-danger light mt-1"
                                                type="submit">Edit Product</button></div>
