                ...
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-5 col-lg-5">
                        ...
                        <form action="/update-profile" method="POST">
                            ...
                            <button type="submit" class="btn btn-primary mt-5" style='margin-left: 65px;'>Update
                                Profile</button>
                            <button type="button" data-toggle="modal" data-target="#exampleModal" class="btn btn-dark mt-5"
                                style='margin-left: 65px;'>Update
                                Password </button>
                            ...
                            <div class="modal-content">
                                ...
                                <form action="{{ url('forget-password') }}" method="POST">
                                    <div class="modal-body">
                                        @csrf
                                        <div class="form-group">
                                            <label for="recipient-name" class="col-md-12">Email:</label>
